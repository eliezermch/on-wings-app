...
export const NavBar = async () => {
  ...
  return (
      <header className="w-full fixed top-0 z-50 bg-background/60 backdrop-blur-md border-b border-primary">
        <nav className="relative max-w-4xl mx-auto px-8 py-4 flex justify-between items-center">
          <div>
